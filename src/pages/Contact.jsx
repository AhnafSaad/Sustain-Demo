          ...
          >
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@sustainsports.com</p>
            ...
            <Card className="leaf-shadow">
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">What makes your products eco-friendly?</h4>
                  <p className="text-sm text-gray-600">
                    All our products are made from sustainable materials like bamboo, recycled ocean plastic, and organic cotton.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Do you offer international shipping?</h4>
                  <p className="text-sm text-gray-600">
                    Currently we ship within the United States. International shipping is coming soon!
                  </p>
                </div>
                <div>
            ...
            <Card className="leaf-shadow">
              <CardContent className="p-0">
                <div className="h-64 bg-gradient-to-br from-green-200 to-emerald-300 rounded-lg flex items-center justify-center">
                  <div className="text-center space-y-2">
                    <MapPin className="w-12 h-12 text-green-700 mx-auto" />
                    <p className="text-green-800 font-medium">Interactive Map</p>
                    <p className="text-green-700 text-sm">Visit our eco-friendly store</p>
                  </div>
                </div>
              </CardContent>
            </Card>
